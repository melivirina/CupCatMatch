...
public class Bomb3 : MonoBehaviour
{
	...
	private static Bomb3 previousSelected = null; private static Bomb3 bomb = null;
	...
	public IEnumerator Wait()
	{
		...
		Destroy(gameObject.GetComponent<Bomb3>());
		StartCoroutine(BoardManager3.instance.FindBomb(transform.position.x, transform.position.y));
	}
	private void Select()
	{
		isSelected = true;
		...
		previousSelected = gameObject.GetComponent<Bomb3>();
	}
