...
public class BoardManager4 : MonoBehaviour
{
    public static BoardManager4 instance;
    ...
    public IEnumerator Add_Score(List<GameObject> matchingTiles)
    {
        ...
        {
            if (matchingTiles[i].GetComponent<SpriteRenderer>().sprite == pussy_use[2])
                GUIManager4.instance.Score += 1;
        }
        if (matchingTiles[1].GetComponent<SpriteRenderer>().sprite == pussy_use[2])
            GUIManager4.instance.Score += 1;
    ...
    public IEnumerator FindNullTiles()
    {
        ...
        for (int x = 0; x < xSize; x++)
        {
            for (int y = 0; y < ySize; y++)
            {
                if ((x == 3 && y == 2) || (x == 3 && y == 3) || tiles[x, y].GetComponent<Bomb4>() != null)
                {
        ...
        for (int x = 0; x < xSize; x++)
        {
            for (int y = 0; y < ySize; y++)
            {
                ...
                if ((x != 3 || y != 2) && (x != 3 || y != 3) && tiles[x, y].GetComponent<Tile4>() != null)
                    tiles[x, y].GetComponent<Tile4>().ClearAllMatches();
            }
        }
        yield return null;
    }
    ...
    private IEnumerator ShiftTilesDown(int x, int yStart, float shiftDelay = .06f)
    {
        ...
        for (int y = yStart; y < ySize; y++)
        {
            ...
            if ((x != 3 || y != 2) && (x != 3 || y != 3) && tiles[x, y].GetComponent<Tile4>() != null)
            {
                ...
                {
                    if (tiles[x, y + 1].GetComponent<Bomb4>() != null && y == ySize - 2)
                    {
                        render.sprite = GetNewSprite(x, ySize - 1);
                    }
                    else if (tiles[x, y + 1].GetComponent<Bomb4>() != null && y < ySize - 2)
                    {
        ...
        {
            GUIManager4.instance.Score2 += 50;
