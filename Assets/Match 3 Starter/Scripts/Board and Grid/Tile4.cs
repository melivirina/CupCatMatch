...
public class Tile4 : MonoBehaviour
{
    ...
    private static Tile4 previousSelected = null;
    ...
    private void Select()
    {
        ...
        previousSelected = gameObject.GetComponent<Tile4>();
    ...
    void OnMouseDown()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    previousSelected.GetComponent<Tile4>().Deselect();
                    Select();
                }
            }
        }
    ...
    public void SwapSprite(SpriteRenderer render2)
    {
        ...
        GUIManager4.instance.MoveCounter--;
    }
    ...
    void ClearMatch(Vector2[] paths)
    {
        ...
        {
            StartCoroutine(BoardManager4.instance.Add_Score(matchingTiles));
            ...
            StartCoroutine(BoardManager4.instance.CreateBomb(transform.position.x, transform.position.y));
        ...
        else if (matchingTiles.Count == 2)
        {
            ...
            StartCoroutine(BoardManager4.instance.FindNullTiles());
