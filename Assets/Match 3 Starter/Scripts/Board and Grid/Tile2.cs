...
public class Tile2 : MonoBehaviour
{
    ...
    private static Tile2 previousSelected = null;
    ...
    private void Select()
    {
        ...
        previousSelected = gameObject.GetComponent<Tile2>();
    ...
    void OnMouseDown()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    previousSelected.GetComponent<Tile2>().Deselect();
                    Select();
                }
            }
        }
    ...
    public void SwapSprite(SpriteRenderer render2)
    {
        ...
        GUIManager2.instance.MoveCounter--;
    }
    ...
    private void ClearMatch(Vector2[] paths)
    {
        ...
        if (matchingTiles.Count >= 3)
        {
            ...
            StartCoroutine(BoardManager2.instance.CreateBomb(transform.position.x, transform.position.y));
        ...
        else if (matchingTiles.Count == 2)
        {
            ...
            StartCoroutine(BoardManager2.instance.FindNullTiles());
